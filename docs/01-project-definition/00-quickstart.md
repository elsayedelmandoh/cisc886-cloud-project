...
This project integrates key cloud computing concepts including storage virtualization, compute scaling, big data processing with Apache Spark, and cloud deployment. The aim of the project is to give you a hands-on experience with a real-world end-to-end ML pipeline on the cloud. 
